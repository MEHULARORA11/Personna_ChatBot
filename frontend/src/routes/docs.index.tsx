    ...
    >
      <div className="flex-1 min-w-0 docs-content space-y-6">
        ...
        <div className="prose prose-zinc dark:prose-invert max-w-none text-sm md:text-base leading-relaxed space-y-4">
          <p>
            The{' '}
            <strong className="font-semibold text-zinc-900 dark:text-zinc-100">Persona ChatBot</strong>{' '}
            is a web-based chat assistant inspired by the distinct communication styles of software educators{' '}
            <strong className="font-semibold text-zinc-900 dark:text-zinc-100">Hitesh Choudhary</strong>{' '}
            and{' '}
            <strong className="font-semibold text-zinc-900 dark:text-zinc-100">Piyush Garg</strong>.
